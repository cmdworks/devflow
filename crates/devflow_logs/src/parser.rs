...
mod tests {
    ...
    fn test_parse_logcat_formats() {
        // -v time format
        let e1 = LogParser::parse_line("09-19 23:13:01.551 I/View    (26435): Frame rendered in 12ms", Some("logcat"));
        assert_eq!(e1.level, LogLevel::I);
        assert_eq!(e1.tag.as_deref(), Some("View"));
        assert_eq!(e1.message, "Frame rendered in 12ms");

        // -v threadtime format
        let e2 = LogParser::parse_line("09-19 23:13:01.551  1511  1520 W ActivityManager: Slow dispatch", Some("logcat"));
